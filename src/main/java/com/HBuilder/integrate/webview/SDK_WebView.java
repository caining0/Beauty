...
public class SDK_WebView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mEntryProxy == null) {
			...
			// 创建5+内核运行事件监听
			WebviewModeListener wm = new WebviewModeListener(this, rootView,getIntent().getStringExtra(SplashActivity.VAL));
			// 初始化5+内核
...
class WebviewModeListener implements ICoreStatusListener {
	...
	public WebviewModeListener(Activity activity, ViewGroup rootView,String url) {
