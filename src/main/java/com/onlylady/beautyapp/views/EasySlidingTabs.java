...
public class EasySlidingTabs extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.selector_home;
...
//        this.setFillViewport(true);
        ...
        this.tabsContainer = new RadioGroup(context);
...
//        this.tabTextColor = a.getColor(1, tabTextColor);
        ...
        this.tabTextSize = a.getDimensionPixelSize(R.styleable.EasySlidingTabs_easyTabTextSize, this.tabTextSize);//add cnn
        ...
        this.mImageWidth =a.getDimensionPixelSize(R.styleable.EasySlidingTabs_easyImageWidth,mImageWidth);
        this.mImageHeight =a.getDimensionPixelSize(R.styleable.EasySlidingTabs_easyImageHeight,mImageHeight);
        a.recycle();
...
//        tab.setSingleLine();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawable = getContext().getResources().getDrawable(top,getContext().getTheme());
        } else {
            drawable = getContext().getResources().getDrawable(top);
        }
        drawable.setBounds(0, 0, mImageWidth, mImageHeight);
        tab.setCompoundDrawables(null, drawable, null, null);//add cnn
...
//        tab.setImageResource(resId);
    ...
    private void addTab(final int position, RadioButton tab) {
...
//        tab.setPadding(2, 0, 2, 0);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (tabsContainer!=null&&tabsContainer.getChildAt(position)!=null)//add cnn
